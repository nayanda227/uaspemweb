...
@section('content')
    <!-- Hero Section -->
<section class="bg-blue-100 py-16 min-h-screen flex items-center" style="background-image: url('{{ asset('images/Group 327.png') }}'); background-size: cover; background-position: center; background-blend-mode: overlay; background-color: rgba(59, 130, 246, 0.2);">
            ...
            <div class="bg-white shadow-md rounded-lg border border-gray-200 p-4">
                ...
                <div class="flex items-center justify-between text-gray-400 mt-4">
                    <span class="flex items-center space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v10a2 2 0 01-2 2h-6l-4 4m0-4v-4m0 4H7a2 2 0 01-2-2V4a2 2 0 012-2h8a2 2 0 012 2v4" /></svg>
                        <span>6</span>
                    </span>
                    <span class="flex items-center space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16.5 10.5L7.5 21m9-10.5L7.5 3m0 18l9-9m-9 0l9-9" /></svg>
                        <span>4</span>
                    </span>
                </div>
            </div>
    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-gray-800">Best LearnPress WordPress Theme Collection For 2023</h3>
                    <div class="flex items-center text-sm text-gray-500 mt-2">
                        <p>Jan 24, 2023</p>
                    </div>
                    <p class="text-gray-600 mt-2 text-sm">Looking for an amazing & well-functional LearnPress WordPress Theme?... </p>
                </div>
            </div>
            <!-- Article Card 2 -->
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
